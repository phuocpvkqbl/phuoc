...
using PhuocProjectTest.Web.Models.Account;
using PhuocProjectTest.Web.Views.Shared.Components.TenantChange;

namespace PhuocProjectTest.Web.Controllers
{
    public class AccountController : PhuocProjectTestControllerBase
    {
